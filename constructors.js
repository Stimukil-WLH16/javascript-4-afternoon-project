...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  // Name and email will be strings, age will be a number and savedPosts will be an array of objects. These objects will each have 3 
  // properties: id (a number), title (a string), and rating (a number between 1 and 5). These objects are the posts that the user will 
  // have saved to their account.
  ...
  // Write a prototype method for the User constructor function named removeSavedPost that will take in one number parameter representing 
  // the post id. Use this id to find and remove the matching object in the savedPosts array.
